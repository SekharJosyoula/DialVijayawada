...
using DV.TeleCallerHelper.Reports.Views;
using Microsoft.Practices.Prism.Regions;
using Microsoft.Practices.Unity;
using Microsoft.Practices.ServiceLocation;

namespace DV.TeleCallerHelper.Reports
{
    public class ReportsModule : IModule
    {
        ...
        public void Initialize()
        {
            ...
            regionManager.RegisterViewWithRegion("RibbonRegion", typeof(ReportsRibbonTab));
            ...
            //container.RegisterType<Object, MainContainer>("ModuleAWorkspace");
        }
